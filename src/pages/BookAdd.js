...
import { getBookById,getAuthor,getGenre,postBook } from '../utils/http'
...
class BookAdd extends Component{
    ...
    render(){
        const {author,genre, isLoading} = this.state
                ...
                <div className="container mt-5 pt-2">
                    ...
                    <div className="row justify-content-center mt-2">
                        <div className="col-lg-4">
                           <span>Title</span>
                           <input name="title" className="form-control" onChange={this.handlerChange}/>
                           <span>Genre</span>
                        ...
                        <div className="col-lg-4">
                           ...
                           <textarea name="description" className="form-control" rows="6" onChange={this.handlerChange}/>
